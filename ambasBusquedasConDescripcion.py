...
class Metodo_de_Busqueda(Nodo):
    ...
    def buscar_solucion_UCS(self, estado_inicial=None, num_hilo=None):
        ...
        while not self.solucionado and len(nodos_frontera) != 0:
            ...
            # Iteracion actual y nodo visitado
            print(f"Iteración {iteraciones}, Nodo visitado: {nodo}, Coste: {nodo.get_coste()}, Desde {nodo_inicial}")
            ...
            # Sumar 1 a contador de iteraciones
            iteraciones += 1
    ...
    def buscar_solucion_BFS(self, estado_inicial=None, num_hilo=None):
        ...
        while not self.solucionado and len(nodos_frontera) != 0:
            ...
            # Iteracion actual y nodo visitado
            print(f"Iteración {iteraciones}, Nodo visitado: {nodo}, Desde {nodo_inicial}")
            ...
            iteraciones += 1 # Sumar 1 a contador de iteraciones
    ...
    def buscar_solucion_Bidireccional(self, algoritmo:str):
        ...
        if algoritmo.lower() == "ucs":
            ...
            print ("Error: Algoritmo inexistente")
            return None
